 ...
 * @author Minoj
 */
public class CreateThreadGUI extends javax.swing.JFrame {

    /**
     * Creates new form CreateThreadGUI
     */
    public CreateThreadGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateThreadGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        if(ChatR_Client.getUser() != null) {
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new CreateThreadGUI().setVisible(true);
                }
            });
        } else {
